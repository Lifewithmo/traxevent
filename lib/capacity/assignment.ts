 ...
 *   i.e. its `leadRequirement` needs the kind AND it is pinned to the unit — mirroring
 *   computeClashes / consumes / rowOwnsClash (all profile-aware). Never the lead itself.
