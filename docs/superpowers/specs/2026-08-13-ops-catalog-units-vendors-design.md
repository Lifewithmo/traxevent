...
Rollup totals render in the most human unit of the ingredient's dimension: largest unit where the quantity is ≥ 1 (5,678 ml → "1.5 gal", 380 g → "13.4 oz"). Entered quantities always render as entered.
